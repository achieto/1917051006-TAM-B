...
public class CardViewPresidentAdapter extends RecyclerView.Adapter<CardViewPresidentAdapter.CardViewViewHolder>{
    ...
    public void onBindViewHolder(@NonNull CardViewPresidentAdapter.CardViewViewHolder cardViewViewHolder, int i) {
        ...
        cardViewViewHolder.btnFavorite.setOnClickListener((View.OnClickListener) new CustomOnItemClickListener(i, new CustomOnItemClickListener.OnItemClickCallback() {
        ...
        cardViewViewHolder.btnShare.setOnClickListener((View.OnClickListener) new CustomOnItemClickListener(i, new CustomOnItemClickListener.OnItemClickCallback() {
            @Override
            public void onItemClicked(View view, int position) {
